...
function App() {
  ...
  // Render hero page - PRODUCTION READY WITH PROPER TAILWIND
  const renderHero = () => {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 relative overflow-hidden">
        ...
        <nav className="bg-white/90 backdrop-blur-sm shadow-sm border-b relative z-10">
          <div className="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={() => setCurrentView(ROUTES.PRICING)}
                className="px-3 py-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-md text-sm hover:from-purple-600 hover:to-pink-600 transition-all"
              >
                {t('pricing')}
              </button>
        ...
        <div className="container mx-auto px-4 py-16 text-center relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                <span className="text-2xl">🔍</span>
              </div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Start Truth Test</h3>
              <p className="text-gray-600">Analyze responses for emotional authenticity</p>
            </button>
            ...
            <button
              ...
              className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group"
            >
              <div className="w-16 h-16 bg-gradient-to-r from-red-500 to-pink-600 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                <span className="text-2xl">📹</span>
              </div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Go Live</h3>
              <p className="text-gray-600">Real-time video truth detection</p>
          ...
          {/* Testimonials */}
          <div className="mt-20">
            <h2 className="text-3xl font-bold text-gray-800 mb-8">What Couples Are Saying</h2>
